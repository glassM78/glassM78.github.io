...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="assets/images/哥斯拉网红钻石玻璃杯1.jpg" alt="First slide" style="width:40%; display: block; margin: 0 auto;">
        </div>
        <div class="item">
            <img src="https://assets/images/哥斯拉网红钻石玻璃杯2.jpg" alt="Second slide" style="width:40%; display: block; margin: 0 auto;">
        </div>
        <div class="item">
            <img src="assets/images/哥斯拉网红钻石玻璃杯3.jpg" alt="Third slide" style="width:40%; display: block; margin: 0 auto;">
        </div>
    </div>
